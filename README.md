...
1. **DONE** Посмотри, на то, как должна будет выглядеть статья, в результате твоей верстки.
...
2. **DONE** Сверстай статью по макету.
...
3. **DONE** Сверстай шапку для нашей статьи.
...
4. **DONE** Сайты должны существовать в разных разрешениях экранов. Поэтому дизайнеры часто делают макеты, показывающие мобильный
